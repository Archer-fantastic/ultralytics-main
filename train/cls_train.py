...
def parse_args():
    ...
    # 训练核心参数
    parser.add_argument("--epochs", type=int, default=50, help="训练轮次（小数据集30-100，大数据集可增加）")
    parser.add_argument("--imgsz", type=int, default=224, help="输入图片尺寸（需为32的倍数，如224/320/640）")
    ...
    parser.add_argument("--cache", type=bool, default=True, help="是否加载入内存，提高训练速度，默认为True")

    # 输出配置
    parser.add_argument("--project", type=str, default="runs/classify", help="训练结果保存根目录")
